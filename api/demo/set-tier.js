...
// api-src/demo/set-tier.ts
var set_tier_exports = {};
__export(set_tier_exports, {
  default: () => handler
});
module.exports = __toCommonJS(set_tier_exports);
...
async function handler(req, res) {
  ...
  try {
    ...
    const account = privateKeyToAccount2(scorerKey);
    ...
    res.end(JSON.stringify({
      success: false,
      error: isRevert ? "Transaction reverted \u2014 scorer wallet may not have setTier permission on the registry" : `Transaction failed: ${msg}`,
      details: msg
    }));
  }
}
