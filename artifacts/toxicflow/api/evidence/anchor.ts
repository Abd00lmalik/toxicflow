// NOTE: Vercel functions are stateless — in-memory cache does not persist across invocations.
// For persistent storage, configure NEXT_PUBLIC_ZG_STORAGE_URL + ZG_SIGNER_PRIVATE_KEY.
